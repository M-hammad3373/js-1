...
const testimonials = [
  ...
  {
    quote: 'As an app developer, I have found this platform to be a game-changer. The detailed guides and practical exercises have made creating robust and efficient applications much more straightforward.',
  ...
  {
    quote: 'The platform is comprehensive resources on app development have been crucial for my career growth. The project-based learning approach is highly effective.',
    name: 'Jon',
    title: 'Mobile App Developer',
  },
  {
