...
"Real-Time Campaign Tracking",
      description:
        "Never worry about outdated data again. Our platform ensures you ha re always working with the latest marketing insights, keeping your strategies up to date without manual effort. Stay aligned with your team, monitor progress in real time, and maintain campaign flow without any disruptions.",
      content: (
